...
; We implement a minimal portion of the Linux/x86 boot protocol.
...
bits 32
check_multiboot:
    cmp eax, 0x2badb002 ; If multiboot, this value will be in the eax register on boot.
    mov [bootinfo], ebx
    jne .no_multiboot
    ret
.no_multiboot:
