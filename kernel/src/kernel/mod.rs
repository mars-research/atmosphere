...
pub fn kernel_test_ipc_test_call(dom0_pagetable_ptr: usize) {
    ...
    let dom0_endpoint_ret =
        KERNEL
            ...
            .as_mut()
            .unwrap()
            .syscall_new_endpoint(0, vPtRegs::new_empty(), 0);
    ...
    let (dom0_proc_ret, proc_ptr_op, thread_ptr_op) = KERNEL
        ...
        .as_mut()
        .unwrap()
        .syscall_new_proc(0, vPtRegs::new_empty(), 0, vPtRegs::new_empty());
    log::info!("new proc \n {:?} \n", dom0_proc_ret);
    let dom1_retstruc = KERNEL
        .lock()
        .as_mut()
        .unwrap()
        .kernel_idle_pop_sched(1, vPtRegs::new_empty());
    ...
    let dom1_retstruc =
        KERNEL
            ...
            .as_mut()
            .unwrap()
            .syscall_reply(1, vPtRegs::new_empty(), dom1_ipc_pay_load);
...
pub fn kernel_test_ipc_send_endpoint(dom0_pagetable_ptr: usize) {
    ...
    let dom0_endpoint_ret =
        KERNEL
            ...
            .as_mut()
            .unwrap()
            .syscall_new_endpoint(0, vPtRegs::new_empty(), 1);
    log::info!("new endpoint \n {:?} \n", dom0_endpoint_ret);
    let (dom0_proc_ret, proc_ptr_op, thread_ptr_op) = KERNEL
        .lock()
        .as_mut()
...
pub fn sys_mmap(va: usize, perm_bits: usize, range: usize) -> usize {
    ...
    let ret_struc = KERNEL
        ...
        .as_mut()
        .unwrap()
        .syscall_malloc(cpu_id, pt_regs, va, perm_bits, range);
...
pub fn sys_resolve(va: usize) -> usize {
    ...
    let ret_struc = KERNEL
        ...
        .as_mut()
        .unwrap()
        .syscall_resolve_va(cpu_id, pt_regs, va);
