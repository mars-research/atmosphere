...
// use mpmc::{Sender, Receiver};
// use spin::{Mutex, RwLock};
use alloc::vec;

use spin::Once; 
use alloc::vec::Vec;
use crate::sync_irq::IrqSafeMutex;
use crate::memory::{PhysicalAddress, MappedPages, create_contiguous_mapping, map_frame_range, BorrowedMappedPages, Mutable, MMIO_FLAGS};
use crate::pci::PciDevice;
use crate::nic_initialization::init_rx_buf_pool;
use crate::mlx_ethernet::{
...
use crate::kernel_config::memory::PAGE_SIZE;
use crate::nic_buffers::{TransmitBuffer, ReceiveBuffer};
...
lazy_static! {
    ...
    pub static ref RX_BUFFER_POOL: mpmc::Queue<ReceiveBuffer> = mpmc::Queue::with_capacity(RX_BUFFER_POOL_SIZE * 2);
}
